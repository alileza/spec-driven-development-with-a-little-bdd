...
3. Human reviews/adjusts plan
4. AI implements against spec
5. Human verifies against spec
6. Iterate
```

**Key insight**: The spec becomes the shared contract between human and AI.
...
> The question isn't "Can AI write good code?"
> It's "Can you give AI clear intent?"

Specs are one way. BDD is another. Find what works for your context.
